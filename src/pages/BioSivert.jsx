          ...
          <BioHeader member={member} />
            ...
            <div className="bio-content">
                <BioImageSection title="Mine interesser" image={`${import.meta.env.BASE_URL}images/sivert/klatring.jpg`}>
                    <p> Utenom skolearbeid og utvikling er jeg også veldig glad i spill, klatring, fridykking og løping.</p>
                    <p>Klatring har steget i interessene mine gjennom årene som student, der det startet rolig i starten av studietiden min
                        ...
                        kan falle ned fra, men som du kan se i bildet har jeg tatt brattkortet mitt som gir meg muligheten å utforde større
                ...
                <BioImageSection title="" image={`${import.meta.env.BASE_URL}images/sivert/fridykking.jpg`}>
                    <p>Jeg trives også veldig med fridykking, som er nesten det stikk motsatte av klatring.
                        Det utfordrer deg på ulike, men også samme arenaer. Der du må klare å holde deg rolig mens du svømmer i havet
                        og utforsker noe som ikke mange ser så ofte i livet sitt. Å lete etter akvatisk liv eller utforske korallrev er unikt
                        og spennende.</p>
                </BioImageSection>
            </div>
        </BioPageWrapper>
