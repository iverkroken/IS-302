...
export default function EditablePage({ storageKey, tag, title }) {
    ...
    <div className="page">
      <div className="container">
        <div className="page__header" ref={headRef}>
          <p className="page__tag mono">{tag}</p>
    ...
    <form className="diary-form" onSubmit={handleSubmit}>
      <div className="diary-form__row">
        <input
          ...
          name="week"
          placeholder="Del / Fase (valgfritt)"
          value={form.week}
        ...
        <input
          className="diary-form__input"
          name="date"
          placeholder="Periode (f.eks. Mai 2026)"
          value={form.date}
          onChange={handleChange}
        />
      </div>
